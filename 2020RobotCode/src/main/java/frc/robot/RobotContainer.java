...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    driver.getAButton().whileHeld(new InstantCommand(Robot.pneumatics::shooterUp, Robot.pneumatics));
    driver.getBButton().whileHeld(new InstantCommand(Robot.pneumatics::shooterDown, Robot.pneumatics));
